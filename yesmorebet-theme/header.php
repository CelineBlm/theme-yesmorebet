            ...
            <nav class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Main Navigation', 'yesmorebet'); ?>">
                ...
                <div class="desktop-nav hide-mobile">
                    ...
                    <div class="nav-right">
                        ...
                        <a href="<?php echo esc_url(home_url('/prestations')); ?>" class="header-cta">
                ...
                <div class="mobile-nav show-mobile">
                    ...
                    <a href="<?php echo esc_url(home_url('/faq')); ?>"><?php esc_html_e('FAQ', 'yesmorebet'); ?></a>
                    <a href="<?php echo esc_url(home_url('/galerie')); ?>"><?php esc_html_e('Galerie', 'yesmorebet'); ?></a>
                    <a href="<?php echo esc_url(home_url('/contact')); ?>"><?php esc_html_e('Contact', 'yesmorebet'); ?></a>
                    <a href="tel:+33626512217" class="header-phone">
